...
type ISingleLinkFieldProperty = ICommonLinkFieldProperty$1;
...
interface IDataCondition {
    ...
    groups?: IGroupItem[];
    series?: ISeries[] | 'COUNTA';
}
interface IConfig {
    dataConditions: IDataCondition | IDataCondition[];
...
declare const baseEventPrefix = "WidgetBaseEvent";
declare const tableEventPrefix = "WidgetTableEvent";
declare const fieldEventPrefix = "WidgetFieldEvent";
